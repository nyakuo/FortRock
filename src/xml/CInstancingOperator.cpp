...
(xmlDocPtr & doc, xmlNodePtr & cur,
 std::shared_ptr<CModuleGenerator> & module_gen) {
  ...
  // std::cout << use_ip_core                       << std::endl
  //           << latency                           << std::endl
  //           << mod_name                          << std::endl
  //           << num_module                        << std::endl
  //           << clock_port_name                   << std::endl
  //           << left_operator_port_name           << std::endl
  //           << right_operator_port_name          << std::endl
  //           << out_port_name                     << std::endl
  //           << left_port_bit_width               << std::endl
  //           << right_port_bit_width              << std::endl
  //           << out_port_bit_width                << std::endl
  //           << clock_enable_port_name << std::endl;
